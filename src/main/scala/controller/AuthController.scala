...
import neko.server.http.{HttpStatus, OK, BAD_REQUEST, UNAUTHORIZED, INTERNAL_SERVER_ERROR}
...
import application.usecase.{FetchUserIdByToken, Login, Logout}
...
object AuthController {
  ...
  val loginRequestDecoder: JsonDecoder[Login.Request] = summon[JsonDecoder[Login.Request]]
